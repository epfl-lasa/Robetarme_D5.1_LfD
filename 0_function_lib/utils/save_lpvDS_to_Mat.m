function save_lpvDS_to_Mat(name, pkg_dir, ds_gmm, Data, Data_sh, data, A_k, b_k, att, x0_all, dt, P_est, constr_type, est_options)
lpvDS_model =[];
lpvDS_model.name         = name;
lpvDS_model.ds_gmm       = ds_gmm;
lpvDS_model.Data         = Data;
lpvDS_model.Data_sh         = Data_sh;
lpvDS_model.data         = data;
lpvDS_model.A_k          = A_k;
lpvDS_model.b_k          = b_k;
lpvDS_model.att          = att;
