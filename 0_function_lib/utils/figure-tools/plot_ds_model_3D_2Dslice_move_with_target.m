function [h,xd] = plot_ds_model_3D_2Dslice_move_with_target(fig, ds, attractor,offset, limits, dimensions, varargin)
...
h = streamslice(d1_tmp, d2_tmp,reshape(xd(dimensions(1),:),ny,nx), reshape(xd(dimensions(2),:),ny,nx),1,'method','cubic');
set(h,'LineWidth', 0.5)
