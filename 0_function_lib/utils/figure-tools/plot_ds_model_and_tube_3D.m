function [h,xd] = plot_ds_model_and_tube_3D(fig, ds, target, limits, start_locations, varargin)
%% W.R. function 
%
%   add a tube on demonstration data
%
quality='medium';
...
hold on;
%%%--------- plot tube
streamtube(x_tmp,y_tmp,z_tmp,reshape(xd(1,:),nx,ny,nz),reshape(xd(2,:),nx,ny,nz),reshape(xd(3,:),nx,ny,nz), startx, starty, startz);
% view(3);
axis tight
shading interp;
camlight; 
