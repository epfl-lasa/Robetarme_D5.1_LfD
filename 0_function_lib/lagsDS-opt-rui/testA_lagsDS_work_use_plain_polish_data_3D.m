...
DS_name         ='2022-01-23-force-vel-DS-demo-polish-floor-phase12-4-lagsDS';
chosen_dataset  = 38; 
...
est_options.sub_sample       = 20;   % Size of sub-sampling of trajectories
                                    % 1/2 for 2D datasets, >2/3 for real    
% Metric Hyper-parameters
est_options.estimate_l       = 1;   % '0/1' Estimate the lengthscale, if set to 1
est_options.l_sensitivity    = 8;   % lengthscale sensitivity [1-10->>100]----wr: this can chahge gaussion num
...
tracking_factor(choosen_active) = 150
% tracking_factor(3) = 2000
% tracking_factor(4) = 50
tracking_factor=[50 100 100 100 100 100 100];
end
