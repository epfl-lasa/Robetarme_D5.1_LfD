...
est_options.l_sensitivity    = 3;   % lengthscale sensitivity [1-10->>100]----wr: this can chahge gaussion num
...
tracking_factor = ones(1,K)*200*15
% tracking_factor = [100 100 100 100]*10
end
...
% save('lagsDS-opt-rui/good_case_using_curve_data_train_lagds');
...
% load([pkg_dir_save '/models/' DS_name],'limits','Xi_ref','x0_all','att','alpha_fun',...
%     'ds_gmm', 'A_g', 'b_g', 'A_l_k', 'b_l_k', 'A_d_k', 'b_d_k', 'h_functor',...
%     'lambda_functor', 'grad_h_functor', 'att_g', 'att_l', 'modulation', 'scale');
