...
pkg_dir = '/home/rui/MATLAB_ON_LINUX/8_Learn_DS_cut_task/lagsDS-opt-rui/';
%%%%%%%%%%%%%%%%%%% Choose a Dataset %%%%%%%%%%%%%%%%%%%%%                     
...
[h_data, h_att, h_vel] = plot_reference_trajectories_DS(Data_mean, att, vel_samples, vel_size);
...
% Learn WSAQF 
scale_prior = 5; % ==> Check that it converges.. if it doesn't, reduce scale!
...
clc;
k_max   = 50; % kappa max (You can define this.. maximum kappa ratio to explore)
eps_max = -10;
for k=1:K     
% for k=4:4
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
modulation = 1; do_scale = 1;
% lags_ds = @(x) lags_ds_nonlinear(x, alpha_fun, ds_gmm, 1/scale*A_g, 1/scale*b_g, A_l_k, b_l_k, A_d_k, b_d_k, h_functor, lambda_functor, grad_h_functor, att_g, att_l, modulation, scale, do_scale);
