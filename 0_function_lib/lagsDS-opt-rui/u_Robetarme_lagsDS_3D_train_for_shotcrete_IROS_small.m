...
DS_name         ='2023-05-23-snake-shape-small';
chosen_dataset  = 42; 
...
est_options.l_sensitivity    = 30;   % lengthscale sensitivity [1-10->>100]----wr: this can chahge gaussion num
...
choosen_active = 1:K
% choosen_active = [12 9 8 12 2 3 7 1 6 11];
...
tracking_factor([1 5 6 7 9]) = 300
tracking_factor([ 3 ]) = 2000
tracking_factor([2 14]) = 50000
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% save workspace incase lost data
save([pkg_dir_save '/models/' DS_name '-goodLAGSDS'],'limits','Xi_ref','x0_all','att','alpha_fun',...
