...
% 16: 2D hard
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pkg_dir         = 'D:\matlab2017\work\8_Learn_DS_cut_task\phys-gmm';
chosen_dataset  = 16; 
sub_sample      = 18; % '>2' for real 3D Datasets, '1' for 2D toy datasets
nb_trajectories = 5; % For real 3D data
Data = load_dataset(pkg_dir, chosen_dataset, sub_sample, nb_trajectories);

%% Position/Velocity Trajectories
vel_samples = 5; vel_size = 0.5; 
